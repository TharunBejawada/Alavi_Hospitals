...
import { SecondOpinionTopic } from "../../../../core/src/types";

export default function SecondOpinionsList() {
    ...
    <div className="p-6 lg:p-10 bg-[#FAFAFA] min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          <h1 className="text-3xl font-bold text-[#5B328C] shrink-0">Second Opinion</h1>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {filteredTopics.map((t) => (
                    <tr key={t.secondOpinionId} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                      <td className="p-5 text-gray-600 font-medium whitespace-nowrap">{t.priorityOrder ?? 99}</td>
